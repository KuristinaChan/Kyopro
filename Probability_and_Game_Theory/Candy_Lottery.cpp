...
//      int n,k;
//      cin>>n>>k;
//      long double expected_value = 0.0;
//      rep(i,1,k+1){
//         long double p1 = 0.0;
//         long double p2 = 0.0;
...
//         rep(j,1,n+1){
//             p1*=(x/(long double)(k));
//             p2*=((x-1.0)/(long double)(k));
//         }
//         expected_value += (p1-p2);
//      }
...
void solve() {
    ...
    long double expected_value = 0.0;
    rep(i, 1, k + 1) {
        long double p1 = 1.0;  // Initialize to 1.0 to accumulate product
        long double p2 = 1.0;  // Initialize to 1.0 to accumulate product
        long double x = (long double)i;
        rep(j, 1, n + 1) {
            p1 *= (x / (long double)(k));           // Update p1
            p2 *= ((x - 1.0) / (long double)(k));   // Update p2
        }
